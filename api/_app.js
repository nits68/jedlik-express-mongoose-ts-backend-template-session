...
class App {
    ...
    initializeMiddlewares() {
        ...
        this.app.use("/docs", swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(_swagger_1.default, options));
    ...
    initializeErrorHandling() {
        this.app.use(_error_middleware_1.default);
    }
