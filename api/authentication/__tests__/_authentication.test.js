...
const _authentication_controller_1 = tslib_1.__importDefault(require("../_authentication.controller"));
let server;
beforeAll(async () => {
    // create server for test:
    server = new _app_1.default([new _authentication_controller_1.default()]);
...
//# sourceMappingURL=_authentication.test.js.map