...
const PostNotFound_exception_1 = tslib_1.__importDefault(require("../exceptions/PostNotFound.exception"));
// import ISession from "../interfaces/session.interface";
//
const auth_middleware_1 = tslib_1.__importDefault(require("../middleware/auth.middleware"));
const roleCheckMiddleware_1 = tslib_1.__importDefault(require("../middleware/roleCheckMiddleware"));
...
const post_dto_1 = tslib_1.__importDefault(require("./post.dto"));
const post_model_1 = tslib_1.__importDefault(require("./post.model"));
class PostController {
    ...
    initializeRoutes() {
        this.router.get(this.path, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"])], this.getAllPosts);
        this.router.get(`${this.path}/:id`, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"])], this.getPostById);
        this.router.get(`${this.path}/:offset/:limit/:sortField/:filter?`, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"])], this.getPaginatedPosts);
        this.router.patch(`${this.path}/:id`, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"]), (0, validation_middleware_1.default)(post_dto_1.default, true)], this.modifyPost);
        this.router.delete(`${this.path}/:id`, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"])], this.deletePost);
        this.router.post(this.path, [auth_middleware_1.default, (0, roleCheckMiddleware_1.default)(["user"]), (0, validation_middleware_1.default)(post_dto_1.default)], this.createPost);
    }
        ...
        try {
            ...
            if (mongoose_1.Types.ObjectId.isValid(id)) {
                ...
                if (post) {
                    ...
                    next(new PostNotFound_exception_1.default(id));
                }
            }
            else {
