...
const _UserNotFound_exception_1 = tslib_1.__importDefault(require("../exceptions/_UserNotFound.exception"));
...
const _post_model_1 = tslib_1.__importDefault(require("../post/_post.model"));
const _user_dto_1 = tslib_1.__importDefault(require("./_user.dto"));
const _user_model_1 = tslib_1.__importDefault(require("./_user.model"));
class UserController {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/posts/`, _auth_middleware_1.default, this.getAllPostsOfLoggedUser);
        this.router.get(`${this.path}/:id`, _auth_middleware_1.default, this.getUserById);
        this.router.get(this.path, _auth_middleware_1.default, this.getAllUsers);
        this.router.get(`${this.path}/posts/search/:keyword`, this.getUsersPostsWithSearch);
        this.router.patch(`${this.path}/:id`, [_auth_middleware_1.default, (0, _validation_middleware_1.default)(_user_dto_1.default, true)], this.modifyUser);
        this.router.delete(`${this.path}/:id`, _auth_middleware_1.default, this.deleteUser);
    }
    /**
     * @openapi
     * /users:
        ...
        try {
            ...
            if (mongoose_1.Types.ObjectId.isValid(id)) {
                ...
                if (user) {
                    ...
                    next(new _UserNotFound_exception_1.default(id));
                }
            }
            else {
...
//# sourceMappingURL=_user.controller.js.map