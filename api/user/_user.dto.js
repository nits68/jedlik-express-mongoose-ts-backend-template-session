...
const _address_dto_1 = tslib_1.__importDefault(require("./_address.dto"));
class CreateUserDto {
    _id;
    name;
    email;
...
tslib_1.__decorate([
    ...
    (0, class_transformer_1.Type)(() => _address_dto_1.default),
    tslib_1.__metadata("design:type", _address_dto_1.default)
