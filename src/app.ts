    ...
    private initializeMiddlewares() {
        ...
        this.app.use(
            cors({
                ...
                allowedHeaders: ["Content-Type", "Authorization", "Cache-Control", "Content-Language", "Expires", "Last-Modified", "Pragma", "connect.sid", "g_state"],
                credentials: true,
        ...
        this.app.use(
            session({
                ...
                cookie: { maxAge: 1000 * 60 * 60 * 24, httpOnly: false, signed: true, secure: false, sameSite: "none" },
